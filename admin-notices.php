...
final class FHTTPS_Admin_Notices {
	...
	private $rate_us_url = 'https://wordpress.org/support/plugin/force-https-littlebizzy/reviews/?rate=5#new-post';
	...
	private $suggestions = array(
		...
		'disable-gutenberg-littlebizzy' => array(
			'name' => 'Disable Gutenberg',
			'desc' => 'Completely disables the Gutenberg block editor and enables the classic WordPress post editor (TinyMCE aka WYSIWYG) for lighter coding and simplicity.',
			'filename' => 'disable-gutenberg.php',
		),
