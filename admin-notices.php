...
final class FHTTPS_Admin_Notices {
	...
	private $suggestions = array(
		...
		'inline-styles-littlebizzy' => array(
			'name' => 'Inline Styles',
			'desc' => 'Automagically loads styles from your active theme and plugins in the site-wide head of your site as internal (embedded) CSS for faster page render.',
			'filename' => 'inline-styles.php',
		),
	);
